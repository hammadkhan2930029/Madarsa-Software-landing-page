export const navItems = [
  { label: 'ہیرو سیکشن', path: '/admin/hero', icon: 'ہ' },
  { label: 'مینو لنکس', path: '/admin/navigation', icon: 'م' },
  { label: 'اعداد کارڈز', path: '/admin/stats', icon: 'ش' },
  ...
  { label: 'سیٹنگز', path: '/admin/settings', icon: 'گ' },
]
